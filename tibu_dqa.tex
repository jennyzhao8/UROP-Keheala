...
\author{Jingyi Zhao\\\small Wellesley College \and Erez Yoeli\\\small MIT Sloan School of Management}
\date{}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{\input{tblSI_error_by_clinic_char_gated.tex}}
\end{table}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{\input{tblSI_error_by_patient_char_gated.tex}}
\end{table}
